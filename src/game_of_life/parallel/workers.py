...
def _init_worker(shm0_name: str, shm1_name: str, shape: tuple[int, int], boundary_mode: BoundaryMode) -> None:
...
class WorkerPool:
    ...
    def __init__(self, current_name: str, next_name: str, shape: tuple[int, int], 
                 boundary_mode: BoundaryMode, n_workers: int):
