...
class Controls:
    ...
    def __init__(self, parent: int | str, on_play_pause, on_step, on_reset, on_speed_change, on_boundary_change):
        ...
        with dpg.group(parent=parent, horizontal=False):
            ...
            self.pattern_listbox = dpg.add_listbox(items=[], width=-1, height=150)
            self._pattern_items = []
