...
CATALOG: list[Pattern] = [
    ...
    Pattern("Pentadecathlon", PatternCategory.OSCILLATOR, 15, _parse_ascii_grid(_PENTADECATHLON_ASCII)),
    
    # Spaceships
    Pattern("Glider", PatternCategory.SPACESHIP, 4, parse_rle("bob$2bo$3o!")),
    Pattern("LWSS", PatternCategory.SPACESHIP, 4, parse_rle("b4o$o3bo$4bo$obo!")),
