...
class PatternDetector:
    ...
    def _generate_transformations(self, cells: frozenset[tuple[int, int]]) -> list[frozenset[tuple[int, int]]]:
    ...
    def detect(self, grid: np.ndarray) -> list[PatternMatch]:
        ...
        for i, sl in enumerate(slices):
            ...
            if matched_name:
                match = PatternMatch(name=matched_name, top_left_r=top_left_r, top_left_c=top_left_c)
